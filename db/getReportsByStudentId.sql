...
SELECT re.id AS report_id, co.id AS comment_id, students.first_name, students.last_name, ch.checks, co.comments, staff.first_name as staff_first_name, staff.last_name as staff_last_name 
FROM reports re
